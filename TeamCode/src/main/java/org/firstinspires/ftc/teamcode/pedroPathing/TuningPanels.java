...
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.changes;
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.drawOnlyCurrent;
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.draw;
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.follower;
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.stopRobot;
import static org.firstinspires.ftc.teamcode.pedroPathing.TuningPanels.telemetryM;
 ...
 */
@Configurable
@TeleOp(name = "Tuning Panels", group = "Pedro Pathing")
public class TuningPanels extends SelectableOpMode {
    ...
    public static void draw() {
        DrawingPanels.drawDebug(follower);
    }
 ...
 */
class LocalizationTestPanels extends OpMode {
    @Override
    public void init() {
 ...
 * @version 1.0, 5/6/2024
 */
class ForwardTunerPanels extends OpMode {
 ...
 */
class LateralTunerPanels extends OpMode {
    public static double DISTANCE = 48;
 ...
 * @version 1.0, 5/6/2024
 */
class TurnTunerPanels extends OpMode {
 ...
 */
class ForwardVelocityTunerPanels extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralVelocityTunerPanels extends OpMode {
    private final ArrayList<Double> velocities = new ArrayList<>();
 ...
 * @version 1.0, 3/13/2024
 */
class ForwardZeroPowerAccelerationTunerPanels extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralZeroPowerAccelerationTunerPanels extends OpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = 30;
    private double previousVelocity;
    private long previousTimeNano;
 ...
 */
class TranslationalTunerPanels extends OpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class HeadingTunerPanels extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class DriveTunerPanels extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class LinePanels extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/13/2024
 */
class CentripetalTunerPanelsPanels extends OpMode {
 ...
 */
class TrianglePanels extends OpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class CirclePanels extends OpMode {
